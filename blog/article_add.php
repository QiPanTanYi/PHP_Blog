	  ...
	  <div class="container mt-5">
		  <form method="POST">
		    <div class="form-group">
		      ...
		      <input type="text" name="title" value="" required class="form-control" id="exampleInputEmail1" placeholder="请输入文章标题">
		    </div>
		    <div class="form-group">
			...
			<div class="form-group">
			  ...
			  <textarea name="content" id="" cols="30" rows="10" placeholder="请输入文章内容" class="form-control mb-3"></textarea>

		    <button type="submit" class="btn btn-primary mr-3">确定添加文章</button>
