<?php
	...
	// 查询分类表中的所有数据
	$result=$db->select('category_list');	
?>
...
<html lang="zh-CN">
  ...
  <body>
	  ...
	  <div class="container mt-5">
		  <a href="./category_add.php" class="btn btn-primary">添加分类</a>
		    ...
		    <tbody>
				...
				<?php $i=0;foreach($result as $row){ ?>
					<tr>
					  ...
					  <td>
							<a href="./category_edit.php?id=<?php echo $row['id']; ?>" class="btn btn-success"><i class="bi bi-pencil"></i></a>
							<a href="./category_del.php?id=<?php echo $row['id']; ?>" class="btn btn-danger"><i class="bi bi-trash"></i></a>
					  </td>
					</tr>
				<?php } ?>
